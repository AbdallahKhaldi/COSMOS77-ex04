...
first. The project logs under the ``cosmos77_ex04`` namespace.
"""
...
def get_logger(name: str = "cosmos77_ex04") -> logging.Logger:
    """Return a logger under the project's ``cosmos77_ex04.*`` namespace."""
