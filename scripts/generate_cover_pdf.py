...
Targets HW4 (exercise number = 4, ex04 repo URL). Field values come from the
...
--template <docx> --output ~/COSMOS77/HW4/COSMOS77-ex04.pdf --exercise-number 4``.
"""
...
_REPO_URL = "https://github.com/AbdallahKhaldi/COSMOS77-ex04"
_STUDENTS = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Generate the COSMOS77-ex04 cover PDF.")
    parser.add_argument("--template", required=True, type=Path)
    parser.add_argument("--output", required=True, type=Path)
    parser.add_argument("--self-score", type=int, default=85)
    parser.add_argument("--exercise-number", type=int, default=4)
